...
interface IState {
  data: ServerRespond[],
  showGraph: boolean,
  intervalId?: NodeJS.Timeout, // Type for setInterval's return value
}
...
class App extends Component<{}, IState> {
   ...
   */
  getDataFromServer() {
    // Start a continuous data fetching process using setInterval
    ...
    // Store the intervalId in state to use it for cleanup
